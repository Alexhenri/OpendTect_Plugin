...
#if defined(Tut_EXPORTS) || defined(TUT_EXPORTS)
# define do_export_Tut
#else
# if defined ( do_export_Tut )
#  undef do_export_Tut
# endif
#endif
...
#if defined( do_export_Tut )
# define Export_Tut	dll_export
# define Extern_Tut
#else
# define Export_Tut	dll_import
# define Extern_Tut	dll_extern
#endif
